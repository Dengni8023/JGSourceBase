...
/// @param iv 偏移向量，可为空
/// @return NSString 加密后的base64字符串
- (nullable NSData *)jg_AES128EncryptDataWithKey:(NSString *)key iv:(nullable NSString *)iv;
...
/// @param iv 偏移向量，可为空
/// @return NSString 加密后的base64字符串
- (nullable NSData *)jg_AES256EncryptDataWithKey:(NSString *)key iv:(nullable NSString *)iv;
...
/// @param iv 偏移向量，可为空
/// @return NSString 解密获取的原始字符串
- (nullable NSData *)jg_AES128DecryptDataWithKey:(NSString *)key iv:(nullable NSString *)iv;
...
/// @param iv 偏移向量，可为空
/// @return NSString 解密获取的原始字符串
- (nullable NSData *)jg_AES256DecryptDataWithKey:(NSString *)key iv:(nullable NSString *)iv;
...
/// @param options 加密模式以及填充模式，默认加密模式为CBC-需要IV，可选ECB-不需要IV，填充模式PKCS7
/// @return NSString 加密结果为base64字符串，解密结果为原始字符串
- (nullable NSData *)jg_AESDataWithOperation:(CCOperation)operation keyLength:(size_t)keyLength key:(NSString *)key iv:(nullable NSString *)iv options:(CCOptions)options;
...
/// @param iv 偏移向量，可为空
/// @return NSString 加密结果为base64字符串，解密结果为原始字符串
- (nullable NSData *)jg_AESDataWithOperation:(CCOperation)operation keyLength:(size_t)keyLength key:(NSString *)key iv:(nullable NSString *)iv;
