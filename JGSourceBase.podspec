...
Pod::Spec.new do |spec|
  ...
  spec.pod_target_xcconfig = {
    ...
    "MARKETING_VERSION" => "${JGSVersion}",
    "CURRENT_PROJECT_VERSION" => "${JGSBuild}",
    # 'GENERATE_INFOPLIST_FILE' => 'YES', # Xcode 新建项目 Target 默认配置为 YES
    'DEFINES_MODULE' => 'YES', # Xcode 新建项目 Target 默认配置为 NO
  }
  ...
  spec.subspec "Base" do |sub|
    sub.source_files = [
      "#{spec.name}/#{spec.name}/*.{h,m,swift}",
      "#{spec.name}/#{spec.name}/JGSBase/**/*.{h,m,swift}",
    ]
    sub.public_header_files = [
      "#{spec.name}/#{spec.name}/*.h",
      "#{spec.name}/#{spec.name}/JGSBase/*.h",
    ]
    # sub.private_header_files = "#{spec.name}/#{spec.name}/JGSBase/*Private.h"
    ...
    sub.resource_bundles = {
      "#{spec.name}" => [
        ...
        "#{spec.name}/#{spec.name}/*.xcprivacy",
        "#{spec.name}/#{spec.name}/JGSBase/**/*.{xcassets,png,jpg,gif}",
        "#{spec.name}/#{spec.name}/JGSDevice/**/JGSiOSDeviceList.json.sec",
        "#{spec.name}/#{spec.name}/JGSIntegrityCheck/**/JGSIntegrityCheckRecordResourcesHash.sh",
      ]
    }
  ...
  spec.subspec 'Category' do |sub|
    sub.source_files = [
      "#{spec.name}/#{spec.name}/JGSCategory/**/*.{h,m,swift}",
    ]
    sub.public_header_files = [
      "#{spec.name}/#{spec.name}/JGSCategory/**/*.h",
    ]
  ...
  spec.subspec 'DataStorage' do |sub|
    sub.source_files = "#{spec.name}/#{spec.name}/JGSDataStorage/**/*.{h,m,swift}"
    sub.public_header_files = "#{spec.name}/#{spec.name}/JGSDataStorage/**/*.h"
  ...
  spec.subspec 'Device' do |sub|
    sub.source_files = "#{spec.name}/#{spec.name}/JGSDevice/**/*.{h,m,swift}"
    sub.public_header_files = "#{spec.name}/#{spec.name}/JGSDevice/**/*.h"
  ...
  spec.subspec 'Encryption' do |sub|
    sub.source_files = "#{spec.name}/#{spec.name}/JGSEncryption/**/*.{h,m,swift}"
    sub.public_header_files = "#{spec.name}/#{spec.name}/JGSEncryption/**/*.h"
  ...
  spec.subspec 'HUD' do |sub|
    ...
    sub.source_files = [
      "#{spec.name}/#{spec.name}/JGSHUD/**/*.{h,m,swift}",
    ]
    sub.public_header_files = [
      "#{spec.name}/#{spec.name}/JGSHUD/**/*.h",
    ]
  ...
  spec.subspec 'IntegrityCheck' do |sub|
    sub.source_files = "#{spec.name}/#{spec.name}/JGSIntegrityCheck/**/*.{h,m,swift}"
    sub.public_header_files = "#{spec.name}/#{spec.name}/JGSIntegrityCheck/**/*.h"
  ...
  spec.subspec 'JSON' do |sub|
    sub.source_files = "#{spec.name}/#{spec.name}/JGSJSON/**/*.{h,m,swift}"
    sub.public_header_files = "#{spec.name}/#{spec.name}/JGSJSON/**/*.h"
  ...
  spec.subspec 'Reachability' do |sub|
    sub.source_files = "#{spec.name}/#{spec.name}/JGSReachability/**/*.{h,m,swift}"
    sub.public_header_files = "#{spec.name}/#{spec.name}/JGSReachability/**/*.h"
  ...
  spec.subspec 'SecurityKeyboard' do |sub|
    sub.source_files = "#{spec.name}/#{spec.name}/JGSSecurityKeyboard/**/*.{h,m,swift}"
    sub.public_header_files = [
      "#{spec.name}/#{spec.name}/JGSSecurityKeyboard/**/**JGSSecurityKeyboard.h",
    ]
